...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const OCCUPIED_SEATS = ['A7', 'B6', 'C5', 'D4', 'E3']; // Mock occupied seats
    const TAX_RATE = 0.10; 
    ...
    function loadBookingData() {
        const dataString = localStorage.getItem('insideout2BookingInfo');
        if (dataString) {
            try {
    ...
    function updateSummaryPanel() {
        ...
        if (isReady) {
            ...
            checkoutBtn.onclick = () => { 
                localStorage.removeItem('insideout2BookingInfo'); 
