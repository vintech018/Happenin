...
document.addEventListener('DOMContentLoaded', function() {
  ...
  selectSeatsBtn.addEventListener('click', function() {
    ...
    const bookingData = {
        eventName: 'Joker: Folie à Deux (Arkham Cinemas)',
        eventDate: selectedDate,
        showTime: selectedTime,
        tickets: totalTickets,
        subtotal: subtotal
    };
    // Use a unique key for Joker's flow data
    localStorage.setItem('jokerBookingInfo', JSON.stringify(bookingData));

    // Redirect to the seat selection page
    window.location.href = "joker-seats.html";
  });
