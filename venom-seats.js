...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const OCCUPIED_SEATS = ['A5', 'B1', 'C1', 'C2', 'D7']; // Mock occupied seats
    const TAX_RATE = 0.10; 
    ...
    let bookingInfo = { 
        tickets: 0, 
        subtotal: 0, 
        eventName: 'Venom: The Last Dance (Marvelplex Cinemas)', 
        eventDate: 'Oct 25', 
        showTime: '02:45 PM',
        selectedTickets: []
    };
    ...
    function loadBookingData() {
        const dataString = localStorage.getItem('venomBookingInfo');
        if (dataString) {
            try {
    ...
    function updateSummaryPanel() {
        ...
        if (isReady) {
            ...
            checkoutBtn.onclick = () => { 
                // Clear temporary Venom data to avoid conflicts
                localStorage.removeItem('venomBookingInfo'); 
