...
document.addEventListener('DOMContentLoaded', function() {
    ...
    slots.forEach(slot => {
      slot.addEventListener('click', function() {
        if (type === 'date') {
            ...
            // Remove selection across IMAX and Standard times
  ...
  selectSeatsBtn.addEventListener('click', function() {
    ...
    localStorage.setItem('oppenheimerBookingInfo', JSON.stringify(bookingData));

    // Redirect to the seat selection page
    window.location.href = "oppenheimer-seats.html";
  });
