  ...
  switch(memberId) {
    case 'vaibhav':
      content = `
        ...
        <div class="modal-body">
          <p>Vaibhav is the visionary behind Happenin, bringing extensive experience in event management and technology.</p>
          <p>With a passion for creating seamless user experiences, he leads the team in developing innovative solutions for event discovery.</p>
    ...
    case 'maanit':
      content = `
        ...
        <div class="modal-body">
          <p>Maanit is the technical genius behind Happenin's platform, specializing in web development and system architecture.</p>
          <p>His expertise in creating scalable and efficient applications ensures that Happenin delivers a smooth experience for all users.</p>
          <div class="modal-social">
    ...
    case 'medhansh':
      content = `
        ...
        <div class="modal-body">
          <p>Medhansh brings creative vision and user-centered design principles to Happenin, crafting intuitive and engaging interfaces.</p>
          <p>His focus on understanding user needs and behaviors helps shape Happenin into a platform that delights users at every interaction.</p>
          <div class="modal-social">
