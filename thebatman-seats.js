...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const OCCUPIED_SEATS = ['A3', 'B7', 'C1', 'D10', 'E4']; // Mock occupied seats
    const TAX_RATE = 0.10; 
    ...
    function loadBookingData() {
        const dataString = localStorage.getItem('thebatmanBookingInfo');
        if (dataString) {
            try {
    ...
    function updateSummaryPanel() {
        ...
        if (isReady) {
            ...
            checkoutBtn.onclick = () => { 
                localStorage.removeItem('thebatmanBookingInfo'); 
