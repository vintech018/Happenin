...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const OCCUPIED_SEATS = ['A10', 'B9', 'C8', 'D7', 'E6']; // Mock occupied seats
    const TAX_RATE = 0.10; 
    ...
    function loadBookingData() {
        const dataString = localStorage.getItem('deadpoolBookingInfo');
        if (dataString) {
            try {
    ...
    function updateSummaryPanel() {
        ...
        if (isReady) {
            ...
            checkoutBtn.onclick = () => { 
                // Clear temporary Deadpool data
                localStorage.removeItem('deadpoolBookingInfo'); 
